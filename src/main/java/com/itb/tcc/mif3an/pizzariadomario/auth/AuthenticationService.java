...
import com.itb.tcc.mif3an.pizzariadomario.exceptions.BadRequest;
import com.itb.tcc.mif3an.pizzariadomario.exceptions.Unauthorized;
...
import com.itb.tcc.mif3an.pizzariadomario.security.token.Token;
import com.itb.tcc.mif3an.pizzariadomario.security.token.TokenRepository;
import com.itb.tcc.mif3an.pizzariadomario.security.token.TokenType;
...
public class AuthenticationService {
	...
	public AuthenticationResponse register(RegisterRequest request) {
		...
		//Usuario usuario;
		String nomeClasse = String.valueOf(request.getTipoUsuario());
		...
		try {
			...
			Class<?> clazz = Class.forName("com.itb.tcc.mif3an.pizzariadomario.model.entity." + nomeClasse); // Obtém a classe
